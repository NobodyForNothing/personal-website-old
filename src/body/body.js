...
function about() {
    ...
    section.appendChild(buildParagraph("Secondly, I strongly believe that individuals should have control over their digital presence, free from reliance on big social media companies. I encourage everyone to build their own websites and shape their online identities according to their own vision."));
